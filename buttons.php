...
<div>
	...
	<div class="footer" style="z-index:100;">		
		<div class="row justify-content-center text-dark ri-2x fw-normal">
			...
			<div class="col">
				<?php if($visualizacion_usuario === 2) : ?>
	...
	<div class="offcanvas-body p-0">
		...
		<!--Usuario real o no logueado-->
			...
			<br><?= empty($nombre_usuario) ? "Imageener" : $nombre_usuario ?>
				<?php if ($suscripcion_usuario > 1) : ?><i type="button" style="decoration-none; color: #F1A40E;" class="ri-shield-star-fill" data-bs-toggle="offcanvas" data-bs-target="#datos-personales" aria-controls="datos-personales"></i><?php endif; ?>
				<?php if ($email_usuario != "imageener@imageen.net") : ?><i type="button" style="decoration-none; color: #2765A0;" class="ri-pencil-fill" data-bs-toggle="offcanvas" data-bs-target="#datos-personales" aria-controls="datos-personales"></i><?php endif; ?>
		</h5>
		...
		<div class="d-flex mb-4 me-2 align-items-center" style="margin-left: 50px;">
			...
			<?php endif; ?>
				...
				<div class="form-check form-control-lg form-switch p-3 d-flex">
					...
					<input class="form-check-input ms-auto mt-0" type="checkbox" role="switch" id="modo-listado-checkbox" onchange="cambiarSwitch(2, <?= $l ?>);" <?= $visualizacion_usuario == 2 ? 'checked' : '' ?>>
				</div>
				<div class="form-check form-control-lg form-switch p-3 d-flex">
					<label class="form-check-label" for="modo-mapa-checkbox"><h6 class="titulo-menu"><?= getTxt(75, $l) ?></h6></label>
					<input class="form-check-input ms-auto mt-0" type="checkbox" role="switch" id="modo-mapa-checkbox" onchange="cambiarSwitch(1, <?= $l ?>);" <?= $visualizacion_usuario == 1 ? 'checked' : '' ?>>
				</div>
			</div>
...
<div class="offcanvas offcanvas-bottom pagina-info" tabindex="-1" id="datos-personales" aria-labelledby="datos-personales-label"style="z-index:3000;">
	...
	<div class="offcanvas-body pt-0 d-flex flex-column align-items-center">
		...
		<h6 class="titulo-menu" data-bs-dismiss="offcanvas" onclick="askClose('<?=$l?>','<?=$nombre_usuario?>')"><?=getTxt(55,$l)?>&nbsp;<h5 style="color: #2765A0"></h5></h6> 
		<h6 class="titulo-menu" data-bs-dismiss="offcanvas" onclick="askCloseUser('<?=$l?>','<?=$nombre_usuario?>')"><?=getTxt(267,$l)?>&nbsp;<h5 style="color: #2765A0"></h5></h6> 
	</div>
</div>
      		...
      		<div class="modal-body">
        		<div class="row mt-20px">
        			<div class="text-center"> 
						...
						<input type="email" class="input-caja form-control" id="box-email4" value="<?=getTxt(266,$l)?>" oninput="cambiosCorreo3()">
		...
		<form class="mb-3 p-3 d-flex flex-column">
			...
			<div class="row row-cols-1 row-cols-md-2">
				<div class="col mb-3">
					...
					<input type="email" class="input-caja form-control" id="box-email3" value="<?=$email_usuario?>" oninput="cambiosCorreo2()">
