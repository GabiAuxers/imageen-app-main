<div id="cookiesAlert" class="modal fade">
	<div class="modal-dialog modal-sm modal-dialog-centered">
		<div class="modal-content bg-primary p-15px text-center">
			...
			<p class="text-white">Usamos cookies propias y de terceros para mejorar nuestros servicios. Si continúa con la navegación, consideraremos que acepta este uso.</p>
			<hr>
			<h4 class="text-white">Cookies Alert</h4>
			<p class="text-white">We use our own and third-party cookies to improve our services. If you continue browsing, we will consider that you accept this use.</p>
...
<div class="offcanvas offcanvas-bottom" tabindex="-1" id="membership" aria-labelledby="membership-label" style="z-index:3000;">
	...
	<div class="offcanvas-body pt-0 d-flex flex-column align-items-center">
		...
		<div id="form-checkout" class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto">
			...
			$sql = "SELECT CODIGO, NOMBRE".$l.", VALIDEZ, PRECIO, ACTIVA, DESTACADA, STRIPEPRICE FROM SUSCRIPCIONES ORDER BY PRECIO";
