...
if (isset($image['output']['data'])) {
    ...
    //$output = Slim::saveFile($data, $id . '_dni1_' . $name, 'fotos/', false);
    ...
    //$foto = "https://www.mjgestion.org/web/cropper/server/fotos/" . $id . '_dni1_' . $name;
    $foto = "https://www.mjgestion.org/web/cropper/server/fotos/" . $name;

    $sql = "UPDATE personas SET DNI1 = '$foto' WHERE CODIGO = '". $id ."'";
