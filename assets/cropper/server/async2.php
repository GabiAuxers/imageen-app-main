...
if (isset($image['output']['data'])) {
    ...
    //$output = Slim::saveFile($data, $id . '_' . $name, 'fotos/', false);
    //$output = Slim::saveFile($data, $name, '../../../httpdocs/cropper/server/fotos/', false);
    //$output = Slim::saveFile($data, $name, '../../../httpdocs/data/fotos/', false);
    //$output1 = Slim::saveFile($data, $name, '../../../world.psiway.com/data/logos/', false);
    $output = Slim::saveFile($data, $name, '../../data/logos/', false);
    //$output3 = Slim::saveFile($data, $name, '../../../www.psiway.com/data/logos/', false);        
    //$output = Slim::saveFile($data, $name, 'fotos/', false);
    ...
    //$foto = "https://www.mjgestion.org/web/cropper/server/fotos/" . $name;
    //$sql = "UPDATE personas SET foto = '$foto' WHERE CODIGO = '". $id ."'";    
