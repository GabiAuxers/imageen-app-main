...
if (isset($image['output']['data'])) {
    ...
    $output = Slim::saveFile($data, $id . '_form_' . $name, 'fotos/', false);
    ...
    $foto = "https://www.mjgestion.org/web/cropper/server/fotos/" . $id . '_form_' . $name;

    $sql = "UPDATE personas SET formulario = '$foto' WHERE CODIGO = '". $id ."'";
