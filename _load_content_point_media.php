...
include 'auth.php';
//Carga de la ventana selectora de medio cuando ya se ha reproducido un medio desde enlace directo
...
if ($conn->connect_error) {
	$additionalInfo = "Fallo en la conexión a la base de datos en la clase _load_content_point_media.php línea 15. Comprueba las credenciales de la base de datos y que el servidor esté funcionando correctamente. Error específico: " . $conn->connect_error;
			...
			<div class="swiper-wrapper">
				...
				while($row = mysqli_fetch_array($result) ) {	
					...
					<div class="swiper-slide" id="<?=$nombre_punto?>#<?=$nombre_material?>">
						...
						<div class="position-absolute top-40 start-50 translate-middle" style="width:100%;">
